...
int main(void) {
    ...
    const char* ip = "192.168.68.50";     // Sensor IP
    const char* user = "root";
    const char* pass = "pass"; // Replace with real password
    ...
    gchar* url = g_strdup_printf("http://%s/axis-cgi/airquality/metadata.cgi", ip);
